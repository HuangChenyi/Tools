...
";
        ...
        internal void UpdateFormVersionField(string formVersionId, string versionField)
        {
...
WHERE 
	[FORM_VERSION_ID] = @FORM_VERSION_ID";
            ...
            this.m_db.AddParameter("@VERSION_FIELD", versionField);
            this.m_db.AddParameter("@FORM_VERSION_ID", formVersionId);
            this.m_db.AddParameter("@MODIFY_DATE", UserTime.GetSystemNowForDb());
            this.m_db.ExecuteNonQuery(cmdTxt);
